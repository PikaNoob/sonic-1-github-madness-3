...
@victory1
        move.b  #id_Victory,obAnim(a0) ; use victory animation
        bra.s   @notright2
...
.CheckLeft:
	cmpi.b	#3,$37(a0)		; Are we leaning near a ledge on the left?
	bne.s	Sonic_LookUp			; If not, branch
...
.BalanceAniBackwards:
	move.b	#id_BalanceBackward,obAnim(a0)			; Set animation to balancing backwards animation
	bra.w	Sonic_ResetScr			; Reset screen position

.BalanceAniForwards:
	move.b	#id_Balance,obAnim(a0)			; Set animation to balancing forwards animation
	bra.w	Sonic_ResetScr			; Reset screen position

; -------------------------------------------------------------------------

; UNUSED - Old balancing code from Sonic 1
...
loc_130A6:
		move.w	#-960,obInertia(a0)
		move.b	#id_Run,obAnim(a0) ; use walking animation
		rts	
; ===========================================================================
...
loc_130BA:
		...
		cmpi.w	#$00,d0
		blt.s	locret_130E8
		move.b	#id_Run,obAnim(a0) ; use "stopping" animation
		bclr	#0,obStatus(a0)
;		move.w	#sfx_Skid,d0
